...
public class burthorpemenuswapper {
    ...
    private final burthorpecalcplugin plugin; // FIXED: Changed to exact lowercase class match layer
    ...
    @Inject
    public burthorpemenuswapper(Client client, burthorpecalcplugin plugin, ItemManager itemManager) { // FIXED: Changed parameter type to lowercase class match layer
        this.client = client;
        this.plugin = plugin;
